# The MultiMask Build System

> _tl;dr_ `yarn dist` for prod, `yarn start` for local development

This directory contains the MultiMask build system, which is used to build the MultiMask Extension such that it can be used in a supported browser.
