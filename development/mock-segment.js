 ...
 * any)
 *
 * This can be used with the MultiMask extension by setting the `SEGMENT_HOST` environment
 * variable or config entry when building MetaMask.
 *
 * For example, to build MultiMask for use with this mock Segment server, you could set the
