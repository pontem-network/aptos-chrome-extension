...
// const { PollingBlockTracker } = require('@pontem/pontem-block-tracker')
...
class TokenTracker extends SafeEventEmitter {
  ...
  constructor (opts = {}) {
    ...
    this.query = new PontemQuery(this.provider)
  ...
  async updateBalances() {
    try {
      ...
      console.log('[Pontem] Token Tracker get error after update balances', reason);
  ...
  _update(newBalances) {
    console.log('[Pontem] Token Tracker _update,', newBalances, this._oldBalances);
