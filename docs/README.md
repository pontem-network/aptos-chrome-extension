...
These docs relate to how to contribute to the MultiMask project itself.

You can find the latest version of MultiMask on [our official website](https://metamask.io/).
...
- [How to port MultiMask to a new platform](./porting_to_new_environment.md)
